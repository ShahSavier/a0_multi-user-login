        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $sql = "SELECT * FROM project_info INNER JOIN users ON project_info.user_id = users.id INNER JOIN lect_info ON lect_info.lect_id = project_info.lect_info_id WHERE project_info.user_id = $usersid";
                    ...
                    if ($result = mysqli_query($conn, $sql)) {
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                echo "<td>";
                                echo '<a href="project-approval-details.php?info_id=' . $row['info_id'] . '" class="mr-3" title="View Record" data-toggle="tooltip"> <span class="fa fa-eye"></span> View Details</a>';
                                echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";
