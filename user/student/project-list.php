<?php 
    ...
    $sql = "SELECT * FROM project_info INNER JOIN users ON project_info.user_id = users.id INNER JOIN lect_info ON lect_info.lect_id = project_info.lect_info_id WHERE project_approval = 'Approve'";  
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#" class="active"><span>Project</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              ...
              <li><a href="project-listresult.php">Project List</a></li>
                ...
                if(mysqli_num_rows($result) > 0)  
                    {  
                       while($row = mysqli_fetch_array($result))  
                          ...
                          ?>  
                          <tr>  
                               <td><?php echo $row["matrix_number"];?></td>  
